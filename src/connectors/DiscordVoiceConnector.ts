...
import { YukitaError, YukitaErrorCode, err, ok, type Result } from '../shared';
import type {
...
export class DiscordVoiceConnector {
  ...
  public constructor(client: YukitaSan, sender: DiscordGatewaySender, options: DiscordConnectorOptions) {
    this.client = client;
    this.sender = sender;
